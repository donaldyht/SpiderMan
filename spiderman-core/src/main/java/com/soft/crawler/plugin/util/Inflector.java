...
public class Inflector {
	...
	public static void main(String[] args){
		String k = "including class";
		System.out.println(Inflector.getInstance().singularize(k));
		System.out.println(Inflector.getInstance().pluralize(k));
	}
    ...
    public void addIrregular( String singular,  String plural ) {
        isNotEmpty(singular, "singular rule");
        isNotEmpty(plural, "plural rule");
    ...
    public void isNotEmpty(String argument, String name){
    	...
    	if (argument != null && argument.trim().length() == 0) {
    		throw new IllegalArgumentException("ArgumentMayNotBeNullOrZeroLengthOrEmpty of->" + name);
    	}
    }
    
    public void isNotZeroLength(String argument, String name){
    	isNotNull(argument, name);
    	if (argument.length() <= 0) {
    		throw new IllegalArgumentException("ArgumentMayNotBeNullOrZeroLength of->" + name);
    	}
    }
    
    public void isNotNull( Object argument, String name ) {
    	if (argument == null) {
    		throw new IllegalArgumentException("ArgumentMayNotBeNull of->" + name);
    	}
    }
